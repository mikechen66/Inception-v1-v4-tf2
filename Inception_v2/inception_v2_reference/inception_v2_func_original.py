...
def googlenet(input_shape, num_classes):
    ...
    inception_3a = inception(input=maxpool2_3x3, fil_1x1_l11=64, fil_3x3_reduce_l12=64, fil_3x3_l21=64, fil_3x3_reduce_l13=64, fil_3x3_l22=96, fil_3x3_l31=96, fil_pool_proj=32)
    inception_3b = inception(input=inception_3a, fil_1x1_l11=64, fil_3x3_reduce_l12=64, fil_3x3_l21=64, fil_3x3_reduce_l13=64, fil_3x3_l22=96, fil_3x3_l31=96, fil_pool_proj=64)
    maxpool3_3x3 = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(inception_3b)

    inception_4a = inception(input=maxpool3_3x3, fil_1x1_l11=224, fil_3x3_reduce_l12=64, fil_3x3_l21=96, fil_3x3_reduce_l13=96, fil_3x3_l22=128, fil_3x3_l31=128, fil_pool_proj=128)
    inception_4b = inception(input=inception_4a, fil_1x1_l11=192, fil_3x3_reduce_l12=96, fil_3x3_l21=128, fil_3x3_reduce_l13=96, fil_3x3_l22=128, fil_3x3_l31=128, fil_pool_proj=128)
    inception_4c = inception(input=inception_4b, fil_1x1_l11=160, fil_3x3_reduce_l12=128, fil_3x3_l21=160, fil_3x3_reduce_l13=128, fil_3x3_l22=160, fil_3x3_l31=160, fil_pool_proj=96)
    inception_4d = inception(input=inception_4c, fil_1x1_l11=96, fil_3x3_reduce_l12=128, fil_3x3_l21=192, fil_3x3_reduce_l13=160, fil_3x3_l22=192, fil_3x3_l31=192, fil_pool_proj=96)
    ...
    inception_5a = inception(input=maxpool4_3x3, fil_1x1_l11=352, fil_3x3_reduce_l12=192, fil_3x3_l21=320, fil_3x3_reduce_l13=160, fil_3x3_l22=224, fil_3x3_l31=224, fil_pool_proj=128)
    inception_5b = inception(input=inception_5a, fil_1x1_l11=352, fil_3x3_reduce_l12=192, fil_3x3_l21=320, fil_3x3_reduce_l13=192, fil_3x3_l22=224, fil_3x3_l31=224, fil_pool_proj=128)
...
def inception(input, fil_1x1_l11, fil_3x3_reduce_l12, fil_3x3_l21, fil_3x3_reduce_l13, fil_3x3_l22, fil_3x3_l31, fil_pool_proj):

    # Layer1-->No.1: Conv 64 1x1 + 1(s)
    conv_1x1_l11 = Conv2D(filters=fil_1x1_l11, kernel_size=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(input)
    bn11 = BatchNormalization()(conv_1x1_l11)
    # Layer1-->No.2: Conv 64 1x1 +１(s), be connected to conv_3x3_l21 (Layer2-->No.1)
    conv_3x3_reduce_l12 = Conv2D(filters=fil_3x3_reduce_l12, kernel_size=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(input)
    bn12 = BatchNormalization()(conv_3x3_reduce_l12)
    # Layer2-->No.1: Conv 64 3x3 + 1(s), conv_3x3_reduce is the cell of Inception Layer 2
    conv_3x3_l21 = Conv2D(filters=fil_3x3_l21, kernel_size=(3,3), padding='same', activation='relu', kernel_regularizer=l2(0.01))(bn12)
    bn21 = BatchNormalization()(conv_3x3_l21)
    # Layer1-->No.3: Conv 64 1x1 1(s), conv_3x3_reduce_l13 is the cell of Inception Layer 1
    conv_3x3_reduce_l13 = Conv2D(filters=fil_3x3_reduce_l13, kernel_size=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(input)
    bn13 = BatchNormalization()(conv_3x3_reduce_l13)
    # Layer2-->No.2: Conv 96 3x3 1(s)
    conv_3x3_l22 = Conv2D(filters=fil_3x3_l22, kernel_size=(3,3), padding='same', activation='relu', kernel_regularizer=l2(0.01))(bn13)
    bn22 = BatchNormalization()(conv_3x3_l22)
    # Layer3-->No.1: Conv 96 3x3 1(s): The Layer 3 has only one cell 
    conv_3x3_l31 = Conv2D(filters=fil_3x3_l31, kernel_size=(3,3), padding='same', activation='relu', kernel_regularizer=l2(0.01))(bn22)
    ...
    # Layer2-->No.3
    avgpool_23_proj = Conv2D(filters=fil_pool_proj, kernel_size=(1,1), strides=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(avgpool_14)
