...
def googlenet(input_shape, num_classes):
    ...
    conv2_1x1_reduce = Conv2D(filters=64, kernel_size=(1,1), strides=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(maxpool1_3x3)
    bn2 = BatchNormalization()(conv2_1x1_reduce)
    ...
    inception_3a = inception(input=maxpool2_3x3, filters_1x1_l11=64, filters_1x1_reduce_l12=64, filters_3x3_l22=64, filters_1x1_reduce_l13=64, filters_3x3_l23=96, filters_3x3_l33=96, filters_1x1_24=32)
    inception_3b = inception(input=inception_3a, filters_1x1_l11=64, filters_1x1_reduce_l12=64, filters_3x3_l22=64, filters_1x1_reduce_l13=64, filters_3x3_l23=96, filters_3x3_l33=96, filters_1x1_24=64)
    maxpool3_3x3 = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(inception_3b)

    inception_4a = inception(input=maxpool3_3x3, filters_1x1_l11=224, filters_1x1_reduce_l12=64, filters_3x3_l22=96, filters_1x1_reduce_l13=96, filters_3x3_l23=128, filters_3x3_l33=128, filters_1x1_24=128)
    inception_4b = inception(input=inception_4a, filters_1x1_l11=192, filters_1x1_reduce_l12=96, filters_3x3_l22=128, filters_1x1_reduce_l13=96, filters_3x3_l23=128, filters_3x3_l33=128, filters_1x1_24=128)
    inception_4c = inception(input=inception_4b, filters_1x1_l11=160, filters_1x1_reduce_l12=128, filters_3x3_l22=160, filters_1x1_reduce_l13=128, filters_3x3_l23=160, filters_3x3_l33=160, filters_1x1_24=96)
    inception_4d = inception(input=inception_4c, filters_1x1_l11=96, filters_1x1_reduce_l12=128, filters_3x3_l22=192, filters_1x1_reduce_l13=160, filters_3x3_l23=192, filters_3x3_l33=192, filters_1x1_24=96)
    maxpool4_3x3 = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(inception_4d)

    inception_5a = inception(input=maxpool4_3x3, filters_1x1_l11=352, filters_1x1_reduce_l12=192, filters_3x3_l22=320, filters_1x1_reduce_l13=160, filters_3x3_l23=224, filters_3x3_l33=224, filters_1x1_24=128)
    inception_5b = inception(input=inception_5a, filters_1x1_l11=352, filters_1x1_reduce_l12=192, filters_3x3_l22=320, filters_1x1_reduce_l13=192, filters_3x3_l23=224, filters_3x3_l33=224, filters_1x1_24=128)
...
def inception(input, filters_1x1_l11, filters_1x1_reduce_l12, filters_3x3_l22, filters_1x1_reduce_l13, filters_3x3_l23, filters_3x3_l33, filters_1x1_24):
    ...
    conv_1x1_reduce_l12 = Conv2D(filters=filters_1x1_reduce_l12, kernel_size=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(input)
    bn12 = BatchNormalization()(conv_1x1_reduce_l12)
    # Layer2-->No.2: Conv 64 3x3 + 1(s), conv_3x3_reduce is the cell of Inception Layer 2
    conv_3x3_l22 = Conv2D(filters=filters_3x3_l22, kernel_size=(3,3), padding='same', activation='relu', kernel_regularizer=l2(0.01))(bn12)
    bn22 = BatchNormalization()(conv_3x3_l22)
    
    # Layer1-->No.3: Conv 64 1x1 1(s), conv_3x3_reduce_l13 is the cell of Inception Layer 1
    conv_1x1_reduce_l13 = Conv2D(filters=filters_1x1_reduce_l13, kernel_size=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(input)
    bn13 = BatchNormalization()(conv_1x1_reduce_l13)
    ...
    # Layer2-->No.4
    avgpool_24_proj = Conv2D(filters=filters_1x1_24, kernel_size=(1,1), strides=(1,1), padding='same', activation='relu', kernel_regularizer=l2(0.01))(avgpool_14)
