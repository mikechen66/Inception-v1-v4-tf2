...
# $ python inception_v2_func_init.py
...
def googlenet(input_shape, num_classes):
    ...
    x = inception(x, params=[(64,),(64,64),(64,96,96),(32,)]) 
    x = inception(x, params=[(64,),(64,64),(64,96,96),(64,)]) 
    x = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(x)

    x = inception(x, params=[(224,),(64,96),(96,128,128),(128,)]) 
    x = inception(x, params=[(192,),(96,128),(96,128,128),(128,)]) 
    x = inception(x, params=[(160,),(128,160),(128,160,160),(96,)]) 
    x = inception(x, params=[(96,),(128,192),(160,192,192),(96,)]) 
    x = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(x)
