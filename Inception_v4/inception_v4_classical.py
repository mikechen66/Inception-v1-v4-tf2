...
to inception stem, it is just addition computation. So the model is simple in the essence. The 
difficutly beghind the algebra is mainly the concept complxity. Please remember even the linear 
...
$ python inception_v4_classical.py
...
# The defualted weights are not suitable to the deeper model becuase it adds the auxilary classifier
...
def inception_v4(input_shape, num_classes, include_top, weights):
    ...
    # Put both x and y into the list 
...
if __name__ == '__main__':
    ...
    model = inception_v4(input_shape, num_classes, include_top, weights)
