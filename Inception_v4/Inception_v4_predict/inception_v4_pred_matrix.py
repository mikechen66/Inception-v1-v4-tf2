...
def inception_v4_base(input):
    ...
    branch_32 = conv2d_bn(basenet, filters=64, kernel_size=(1,1), strides=(1,1))
    branch_42 = conv2d_bn(branch_32, filters=96, kernel_size=(3,3), strides=(1,1), padding='valid')

    branch_33 = conv2d_bn(basenet, filters=64, kernel_size=(1,1), strides=(1,1))
    branch_43 = conv2d_bn(branch_33, filters=64, kernel_size=(1,7), strides=(1,1))
    branch_53 = conv2d_bn(branch_43, filters=64, kernel_size=(7,1), strides=(1,1))
    branch_63 = conv2d_bn(branch_53, filters=96, kernel_size=(3,3),  strides=(1,1), padding='valid')

    basenet = concatenate([branch_42,branch_63], axis=bn_axis)

    branch_83 = conv2d_bn(basenet, filters=192, kernel_size=(3,3), strides=(2,2), padding='valid')
    branch_84 = MaxPooling2D((3,3), strides=(2,2), padding='valid')(basenet)

    basenet = concatenate([branch_83,branch_84], axis=bn_axis)
